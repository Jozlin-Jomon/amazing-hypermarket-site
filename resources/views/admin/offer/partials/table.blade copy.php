                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div id="edit_percentage-value" class="discount-value-field" style="display: none;">
                                    <label for="discount_value">Discount (%)</label>
                                    <input type="number" id="edit_discount_value_percentage" name="discount_value_percentage" class="form-control" min="1" max="100" step="1">
                                </div>
                                <div id="edit_fixed-value" class="discount-value-field" style="display: none;">
                                    <label for="discount_value">Discount Amount</label>
                                    <input type="number" id="edit_discount_value_fixed" name="discount_value_fixed" class="form-control" step="0.01" min="0">
                                </div>
                            </div>
                        </div>
