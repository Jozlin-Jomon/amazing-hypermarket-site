...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll('.edit-offer').forEach(button => {
        button.addEventListener('click', () => {
            ...
            document.getElementById('update-offer-id').value = offerId;
    ...
    document.getElementById('update-offer-form').addEventListener('submit', function (e) {
        e.preventDefault();
        const form = e.target;
        ...
        .then(data => {
            ...
            bootstrap.Modal.getInstance(document.getElementById('updateOffer')).hide();
